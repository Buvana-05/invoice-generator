...
public class PdfGenerationService {
	public byte[] generateInvoicePdf(Invoice invoice) {
		...
		try {
			...
			document.add(new Paragraph(invoice.getCompanyDetails().getName() != null
			        ? invoice.getCompanyDetails().getName() : "", normalFont));
			document.add(new Paragraph(invoice.getCompanyDetails().getAddress() != null
			        ? invoice.getCompanyDetails().getAddress() : "", normalFont));
			document.add(new Paragraph(invoice.getCompanyDetails().getEmail(), normalFont));
			document.add(new Paragraph(invoice.getCompanyDetails().getPhone(), normalFont));
			...
			document.add(new Paragraph(invoice.getCustomerDetails().getEmail(), normalFont));
			document.add(Chunk.NEWLINE);
